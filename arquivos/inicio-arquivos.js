function showContent(section) {
    ...
    if (section === 'vendas') {
        content.innerHTML = `
            <!-- Conteúdo Vendas -->
            <a href="#"><button>Arquivos Gerentes</button></a>
            <a href="#"><button>VENDAS X DEVOLUÇÃO</button></a>
        ...
        content.innerHTML = `
            <!-- Conteúdo Trade -->
            <a href="link25.html"><button disabled>EM CONSTRUÇÃO</button></a>
            <a href="link26.html"><button disabled>EM CONSTRUÇÃO</button></a>
